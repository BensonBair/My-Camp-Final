...
function AuthBar() {
  ...
  return (
	...
	<header style={{position:'absolute',height:30,right:10,marginTop:0}}>
	 ...
	 <meta name="google-signin-client_id" content="742737297171-acoq4kfrni1e5a6io38k7a33n506mkql.apps.googleusercontent.com" />
	  <GoogleLogin
		clientId="742737297171-acoq4kfrni1e5a6io38k7a33n506mkql.apps.googleusercontent.com"
		buttonText="Login"
		onSuccess={success}
		onFailure={failure}/>
	  <GoogleLogout
